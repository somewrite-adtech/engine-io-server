        ...
        (on :connection *server*
            (lambda (socket)
              (let ((last-sent 0)
                ...
                (assert (string= (query-parameter (socket-request socket) "transport")
                                 "polling"))
                ...
                (on :upgrade socket
                    (lambda (to)
                      ...
                      (assert (string= (transport-name (socket-transport socket)) "websocket"))))
